...
This release closes a 26-finding bug-audit cycle (the audit lives in `planning/audits/`, the implementation arc in `planning/changes/archive/2026-06-05.01-bug-audit-v2/`, and the retro in `planning/retros/`). The changes split across four shipped PRs:
...
- `planning/changes/archive/2026-06-05.01-bug-audit-v2/design.md` — the 3-PR breakdown
...
- Sequencing: [`planning/changes/archive/2026-06-05.01-bug-audit-v2/design.md`](../changes/archive/2026-06-05.01-bug-audit-v2/design.md)
